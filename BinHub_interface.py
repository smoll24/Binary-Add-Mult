...
MODNAMES = {
    "BinAdd_interface" : 'Addition',
    "BinMult_interface" : 'Multiplication',
    }
...
def create_window():
    ...
    root.title('Addition et Multiplication Binaire')
    ...
    entete = tk.Label(fenetre, text='Addition et Multiplication\nBinaire', font=('Arial', 14, 'bold'), fg='#0c6bab', bg='#e4e4e4')
